...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/Metal Slug.oep", __ASSET__assets_data_metal_slug_oep);
		type.set ("assets/data/Metal Slug.oep", AssetType.TEXT);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_metal_slug_oep extends flash.utils.ByteArray { }
...
@:file("assets/data/Metal Slug.oep") #if display private #end class __ASSET__assets_data_metal_slug_oep extends lime.utils.Bytes {}
